      ...
      <div className="wrap">
        ...
        <div className="hero-grid">
          <div className="hero-text">
            ...
            <a id="lead" href="https://app.leadster.com.br/capture/d7TGpeHYhhrspZ7i" target="_blank" rel="noopener" className="cta">
              {ctaLabel}
              <Icons.Arrow />
            </a>
              ...
              <div className="phone-screen">
                ...
                <div className="phone-content">
                  ...
                  <div className="phone-card" style={{ background: '#fff5e8' }}>
                    ...
                    <p className="phone-card-title">Recupere seu perfil com um especialista</p>
                    <div className="phone-bars">
                      <span></span><span></span>
                    </div>
                  </div>
